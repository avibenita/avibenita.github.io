...
(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '.ws-device-frame{position:relative;width:100%;flex:1;min-height:0;padding:2px;box-sizing:border-box;border-radius:13px;background:#ccd2db;border:1px solid rgba(15,23,42,.10);box-shadow:0 10px 28px rgba(15,23,42,.16)}',
  ...
  function ensureModal() {
    ...
    wrap.innerHTML = [
      ...
      '    <section class="ws-device-frame" aria-label="Workspace demo frame">',
      '      <div class="ws-screen">',
