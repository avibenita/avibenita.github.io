...
$src = Join-Path $root "statistic-calculators\power-sample-size-calculator"
...
Write-Host "Synced embed from statistic-calculators/power-sample-size-calculator/ -> statistico-analytics/embed/"
