...
const StatisticoHeader = {
  ...
  _ensurePlainTabUnderlineStyles() {
    ...
    style.textContent = [
      ...
      '  border-bottom: 1px solid rgba(120, 200, 255, 0.42) !important;',
      '  background: var(--surface-1, #1a1f2e) !important;',
      '}',
      '.ws-shell:has(.ws-mode-bar--connected) {',
      '  --ws-conn-line: rgba(120, 200, 255, 0.42) !important;',
      '  --ws-conn-shell: rgba(148, 163, 184, 0.22) !important;',
      '  border: 1px solid var(--ws-conn-shell) !important;',
      '}',
      '.ws-shell:has(.ws-mode-bar--connected) > .ws-body {',
      '  background: var(--surface-1, #1a1f2e) !important;',
      '  border: 1px solid var(--ws-conn-line) !important;',
      ...
      '  border: 1px solid rgba(120, 200, 255, 0.42) !important;',
      '  border-top: 3px solid #8b5cf6 !important;',
      '  border-bottom: 2px solid var(--surface-1, #1a1f2e) !important;',
      '  border-radius: 8px 8px 0 0 !important;',
      ...
      '}',
      '.ws-mode-bar--connected .ws-mode-tab.active::after {',
      '  content: "" !important;',
