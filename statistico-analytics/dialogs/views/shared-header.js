...
const StatisticoHeader = {
  ...
  _ensurePlainTabUnderlineStyles() {
    ...
    style.textContent = [
      ...
      '  background: linear-gradient(180deg, rgba(36, 46, 68, 0.62) 0%, rgba(16, 22, 36, 0.58) 100%) !important;',
      '  background-image: linear-gradient(180deg, rgba(36, 46, 68, 0.62) 0%, rgba(16, 22, 36, 0.58) 100%) !important;',
      ...
      '  filter: saturate(0.75) brightness(0.96) !important;',
      '  box-shadow: none !important;',
      '}',
      ...
      '  opacity: 1 !important;',
      '  filter: none !important;',
      '  box-shadow: 0 0 12px rgba(109, 40, 217, 0.28), 0 0 22px rgba(109, 40, 217, 0.12), inset 0 0 0 1px rgba(109, 40, 217, 0.12) !important;',
      '}',
      ...
      '  opacity: 0.7;',
      '  background: conic-gradient(from 0deg, rgba(109, 40, 217, 0.42) 0%, rgba(59, 130, 246, 0.28) 22%, transparent 40%, transparent 100%) !important;',
      '}',
