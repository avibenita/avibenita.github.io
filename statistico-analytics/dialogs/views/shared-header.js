...
const StatisticoHeader = {
  ...
  _ensurePlainTabUnderlineStyles() {
    ...
    style.textContent = [
      ...
      '}',
      '',
      '/* Workspace chip tabs — dim inactive, bright active, no underline */',
      '.ws-mode-bar--attached:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active),',
      '.ws-mode-bar:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active) {',
      ...
      '}',
      '.ws-mode-bar--attached:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active) .ws-tab-label,',
      '.ws-mode-bar:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active) .ws-tab-label {',
      '  color: #334155 !important;',
      '}',
      '.ws-mode-bar--attached:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active) .ws-tab-sub,',
      '.ws-mode-bar:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active) .ws-tab-sub {',
      '  color: #64748b !important;',
      '}',
      '.ws-mode-bar--attached:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active) > i,',
      '.ws-mode-bar:not(.ws-mode-bar--slant) .ws-mode-tab:not(.active) > i {',
      '  color: #7c3aed !important;',
      '  opacity: 0.78 !important;',
      '}',
      '.ws-mode-bar--attached:not(.ws-mode-bar--slant) .ws-mode-tab:hover:not(.active),',
      '.ws-mode-bar:not(.ws-mode-bar--slant) .ws-mode-tab:hover:not(.active) {',
