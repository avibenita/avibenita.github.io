(function(){
  ...
  function renderAnalysisLayout(container, opts) {
    ...
    container.innerHTML = [
      ...
      '    </div>',
      '  </div>',
      '  <div class="pwstd-band pwstd-band--recommend pwstd-band--analysis" id="' + id(ids,'status','powStatusMessage') + '" hidden>Run analysis to populate power results.</div>',
      '</div>'
    ].join('\n');
