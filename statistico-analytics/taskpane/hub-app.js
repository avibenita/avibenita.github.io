...
const TOOLS_CATEGORY_TILES = [
     ...
     Specialized modules that work on the Excel range/selection itself. */
  {
    ...
    icon: "fa-table",
    iconSvg: '<svg viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="14" style="display:block"><rect x="0.75" y="0.75" width="18.5" height="14.5" rx="1.5" stroke="currentColor" stroke-width="1.5"/><path d="M1 5h18M1 9.5h18M7.5 5v10" stroke="currentColor" stroke-width="1.5"/><rect x="1.5" y="1.5" width="17" height="3" fill="currentColor" opacity="0.35"/></svg>',
    accent: "#eab308",
    accentDark: "#a16207",
    color: "#eab308",
    colorDark: "#a16207",
