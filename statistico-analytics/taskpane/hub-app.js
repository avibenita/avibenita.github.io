...
function openExternalDialogUrl(url, options) {
  ...
  var opts = options || { height: 72, width: 70, displayInIframe: false };
...
function openBuilderDialogFromHub(options) {
  ...
  Office.context.ui.displayDialogAsync(
    ...
    options.dialogOptions || { height: 70, width: 25, displayInIframe: false },
    function (res) {
      if (res.status === Office.AsyncResultStatus.Failed) {
...
function openMixedConfigFromHub() {
  return openBuilderDialogFromHub({
    ...
    dialogOptions: { height: 96, width: 32, displayInIframe: false },
    dataType: "MIXED_DATA",
    payloadBuilder: function (gr) {
      var saved = null;
